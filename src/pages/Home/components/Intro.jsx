  ...
  return (
    <div className="intro-co">
      <div className="intro-content">
        <span className="intro-hello">سلام به شما ✨🤗</span>
        <h1 className="intro-title">
          متخصص توسعه‌دهنده فرانت‌اند | React & Modern Web Technologies
        </h1>
        <h2 className="text-4xl font-[Digi-Titr] text-center">
          تبدیل صفر و یک به تجربه!
        </h2>
        <p className="text-sm text-gray-700 text-wrap">
          متخصص توسعه‌دهنده فرانت‌اند با تخصص در React.js و کتابخانه‌های مدرن،
          دارای تجربه در ساخت اپلیکیشن‌های وب مقیاس‌پذیر، پویا و کاربرپسند.
          متعهد به نوشتن کدهای تمیز، قابل نگهداری و با تمرکز بر تجربه کاربری
          برتر و کارایی عالی.
        </p>
